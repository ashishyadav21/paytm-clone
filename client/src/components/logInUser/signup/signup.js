...
const SignUpPage = ({setLoginPageVisible}) => {
    ...
    return(
            <div class="bg-primary flex p-12">
                 <div class=" container mt-10 bg-white  flex flex-col">
                    ...
                    <input class='outline-none text-placeholderColor font-bold' placeholder="Enter Mobile"/>
                    </div>
                    <div class='p-4 h-14 flex justify-between items-center'>
                    <input class='outline-none text-placeholderColor font-bold' placeholder="Enter Email (Optional)"/>
                    </div>
                    <div class='p-4 h-14 flex justify-between items-center'>
                    <input class='outline-none text-placeholderColor font-bold' placeholder="Enter Password"/>
                    ...
                    <button class='mt-4 h-12 w-44 p-2 text-center text-sm text-white rounded-full bg-primaryButton'>send verification OTP</button>
